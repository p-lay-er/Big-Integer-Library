...
string compare_max(string str1, string str2);
string compare_min(string str1, string str2);
string factorial(int num);
string rmv_zero(string str);
...
string subtract(string s1, string s2)
{
    ...
    for (i = k - 1; i >= 0; i--)
    {
        output_val += (char)(A[i] + 48);
    }
    output_val = rmv_zero(output_val);
...
string multiply(string s, string s1)
{
    ...
    for (int i = 0; i < m + n; i++)
    {
        ...
        if (flag == 1)
            finaloutput_val += (char)(A[i] + 48);
    }
    if (finaloutput_val.size() == 0)
        finaloutput_val = "0";
    return finaloutput_val;
}
...
string compare_max(string s1, string s2)
{
    string output_val = "";
    int i;
    if (s1[0] == '-' and s2[0] != '-')
...
string compare_min(string s1, string s2)
{
    string ans;
    ans = compare_max(s1, s2);
    if (ans == s1)
